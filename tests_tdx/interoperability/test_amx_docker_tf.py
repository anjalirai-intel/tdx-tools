...
pytestmark = [
    pytest.mark.vm_name("td-amx-vm-docker"),
...
def test_vm_docker_tf_infer_mobilenetv1_int8(vm_factory, vm_type, vm_ssh_pubkey, vm_ssh_key):
    """
    Test MobileNetV1 inference with INT8:
    Ref: https://github.com/IntelAI/models/blob/master/benchmarks/ \
    image_recognition/tensorflow/mobilenet_v1/inference/int8/README.md
    """
...
@pytest.mark.parametrize("vm_type", [VM_TYPE_TD, VM_TYPE_EFI, VM_TYPE_LEGACY])
def test_vm_docker_tf_infer_dien_bf16(vm_factory, vm_type, vm_ssh_pubkey, vm_ssh_key):
    """
